...
nov.controller('ParticipationCtrl', ['$scope', '$stateParams', 'Data', 'userModel', function ($scope, $stateParams, Data, userModel) {
    $scope.userModel = userModel;
    $scope.user = $scope.userModel.getUser();
    $scope.course = Data.getCourse($stateParams.courseId);
}]);
...
nov.controller('GradesCtrl', ['$scope', '$stateParams', 'Data', 'userModel', function($scope, $stateParams, Data, userModel) {
    ...
    $scope.grades = grades;
    var student = Data.getStudent();
    $scope.student = student;
}]);

nov.controller('GradeSubviewCtrl', ['$scope', '$stateParams', 'Data', 'userModel', function ($scope, $stateParams, Data, userModel) {
    $scope.userModel = userModel;
    $scope.user = $scope.userModel.getUser();
    $scope.course = Data.getCourse($stateParams.courseId);
    var grades = Data.getCourseGrades($stateParams.courseId);
...
nov.controller('QuizzesCtrl', ['$scope', '$stateParams', 'Data', 'userModel', '$filter', function($scope, $stateParams, Data, userModel, $filter) {
	...
	$scope.quizzes = quiz_jsonParser.jsonData.objects;
}]);
...
nov.controller('QuizCtrl', ['$scope', '$stateParams', 'Data', 'userModel', '$filter', function($scope, $stateParams, Data, userModel, $filter) {
	...
	var quizzes = quiz_jsonParser.jsonData.objects;
